...
const page = () => {
  return (
    <div>
      ...
      <div className="text-center bg-[#FFFDF2] pt-[5%]">
        ...
        <div className="flex flex-wrap justify-center ml-[3%] px-[15%] mt-[2%]">
          <div className="w-[100%] flex justify-center rounded-[16px]  bg-white">
            <div className="flex items-center">
              <Image className="rounded-s-[16px]" width={600} src={wellnessImg} />
            </div>

            <div className="text-left py-[2%] px-[3%]">
              <h1 className="text-[14px] text-[#6941C6] font-semibold mb-[5%]">Olivia Rhye • 20 Jan 2024</h1>
              <h1 className="text-[#002C3C] text-[18px] font-medium mb-[5%]">Mindful Mornings: A Guide to Starting Your Day Right</h1>
              ...
              <div className="flex mt-[15%]">
                <button className="bg-[#F9F5FF] px-[15px] border-[#E9D7FE] border-[1px] rounded-[10px] mr-[3%] text-[#6941C6]">Design</button>
                <button className="bg-[#EEF4FF] px-[15px] border-[#C7D7FE] border-[1px] rounded-[10px] mr-[3%] text-[#3538CD]">Research</button>
              </div>
            </div>
          </div>
